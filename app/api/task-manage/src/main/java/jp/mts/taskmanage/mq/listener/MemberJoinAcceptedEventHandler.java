...
@Component
@MqEventHandlerConfig(targetEventTypes="jp.mts.authaccess.domain.model.MemberJoinAccepted")
public class MemberJoinAcceptedEventHandler implements MqEventHandler {
