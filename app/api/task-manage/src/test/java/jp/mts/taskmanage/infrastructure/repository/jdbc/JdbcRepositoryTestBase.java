...
import jp.mts.taskmanage.infrastructure.repository.jdbc.JdbcRepositoryTestBase.TestConfig;
...
@ActiveProfiles("test")
public abstract class JdbcRepositoryTestBase {
	...
	public static class WithActiveJdbc extends ExternalResource {
		...
		private JdbcRepositoryTestBase test;
		
		public WithActiveJdbc(JdbcRepositoryTestBase test) {
			this.test = test;
		}
